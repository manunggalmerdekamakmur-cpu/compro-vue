    ...
    <div class="container">
      <div class="footer-content">
        ...
        <div class="footer-links">
          ...
          <ul>
            <li>
              <a href="#home" @click="handleFooterLinkClick"
                ><i class="fas fa-home"></i> Beranda</a
              >
            </li>
            <li>
              <a href="#about" @click="handleFooterLinkClick"
                ><i class="fas fa-info-circle"></i> Tentang Kami</a
              >
            </li>
            <li>
              <a href="#visi-misi" @click="handleFooterLinkClick"
                ><i class="fas fa-eye"></i> Visi & Misi</a
              >
            </li>
            <li>
              <a href="#products" @click="handleFooterLinkClick"
                ><i class="fas fa-boxes"></i> Produk Kami</a
              >
            </li>
            <li>
              <a href="#certifications" @click="handleFooterLinkClick"
                ><i class="fas fa-certificate"></i> Sertifikasi</a
              >
            </li>
            <li>
              <a href="#contact" @click="handleFooterLinkClick"
        ...
        <div class="footer-contact">
          ...
          <div class="contact-info-footer">
            <p>
              <i class="fas fa-envelope"></i> manunggalmerdekamakmur@gmail.com
            </p>
            <p>
              <i class="fas fa-map-marker-alt"></i> Kabupaten Nganjuk, Jawa
              Timur
            </p>
          </div>
        </div>
      ...
      <div class="footer-bottom">
        <div class="copyright">
          <p>
            &copy; {{ currentYear }} PT. Manunggal Merdeka Makmur. All rights
            reserved.
          </p>
          <p class="thank-you">
            Atas perhatian dan kepedulian serta kebijaksanaannya kami ucapkan
            terima kasih.
          </p>
        </div>
      </div>
