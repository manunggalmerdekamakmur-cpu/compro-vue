  ...
  <section class="company-showcase section-bg" id="why-us">
    <div class="container full-width why-choose">
      <div class="section-head">
        ...
        <p class="lead">
          Sebagai pelopor inovasi agrobisnis, kami menghadirkan solusi pertanian
          berkelanjutan yang mengutamakan kualitas, keandalan, dan dampak
          positif bagi ekosistem.
        </p>
      </div>
    ...
    <div
      class="container full-width achievements"
      style="margin-top: var(--space-xl); padding-top: var(--space-xl)"
    >
      ...
      <div class="counters-grid">
        ...
        >
          <template v-if="!hasAnimated">
            <p
              class="counter-label skeleton-label"
              :style="{ width: counter.isComingSoon ? '60%' : '90%' }"
            >
              <strong>{{ counter.key }}</strong>
            </p>
            <div
              class="counter-number skeleton-number"
              :style="{ width: counter.isComingSoon ? '40%' : '70%' }"
            >
            ...
            <div
              class="counter-unit skeleton-unit"
              :style="{ width: counter.unit ? '30%' : '0' }"
            >
              {{ counter.unit }}
            </div>
          </template>
          <template v-else>
            ...
            <div class="counter-number">
              <span
                :class="{
                  'coming-soon': displayedCounts[index] === 'Coming Soon',
                }"
              >
